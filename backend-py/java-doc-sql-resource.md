# Qifu4 Backend Doc / SQL Resource

Documentation resources under `backend/doc`, including `qifu4.sql`.
...
### `backend/doc/menutest.json`

- Purpose: JSON configuration/resource data used by endpoints, publishing, permissions, messages, menu data, or tests.
- JSON root type: `array`
- Item/key count: 5
- Top-level keys: `id`, `type`, `name`, `icon`, `items`
- Full path: `C:\home\qifu4\backend\doc\menutest.json`
- Size: 4518 bytes
...
[
	{
		...
		"items"	:	[
			...
			{
				"id"	:	"CORE_PROG001D0003Q",
				"type"	:	"I",
				"name"	:	"ZA03 - Menu settings",
				"icon"	:	"globe2",
				"url"	:	"#/prog01/c2/f11e322d-9126-4760-bd2b-24d78b7fa85a"
			},
			{
				"id"	:	"CORE_PROG001D0004Q",
				"type"	:	"I",
				"name"	:	"ZA04 - Template",
				"icon"	:	"globe2",
				"url"	:	"#/prog01/c2/0000"
    ...
    ,
    {
		"id"	:	"CORE_PROG002D",
		"type"	:	"F", 
		"name"	:	"ZB. Role authority",
		"icon"	:	"globe2",
		"items"	:	[
			{
				"id"	:	"CORE_PROG002D0001Q",
				"type"	:	"I",
				"name"	:	"ZB01 - Role",
				"icon"	:	"globe2",
				"url"	:	"#/prog01c1"
            ...
            ,
			{
				"id"	:	"CORE_PROG002D0003Q",
				"type"	:	"I",
				"name"	:	"ZB03 - Role for menu",
				"icon"	:	"globe2",
				"url"	:	"#/prog01c1"
			}            
        ]
    ...
    ,
    {
		...
		"items"	:	[
            ...
            ,
			{
				"id"	:	"CORE_PROG003D0002Q",
				"type"	:	"I",
				"name"	:	"ZC02 - Expression",
				"icon"	:	"globe2",
				"url"	:	"#/prog01c1"
			}
            ,
			{
				"id"	:	"CORE_PROG003D0003Q",
				"type"	:	"I",
				"name"	:	"ZC03 - Bean support",
				"icon"	:	"globe2",
				"url"	:	"#/prog01c1"
			}
            ,
			{
				"id"	:	"CORE_PROG003D0006Q",
				"type"	:	"I",
				"name"	:	"ZC06 - Expression Job",
				"icon"	:	"globe2",
				"url"	:	"#/prog01c1"
			}                               
        ]        
    ...
    ,
    {
        ...
        "items"	:	[
            ...
            ,        
			{
				"id"	:	"CORE_PROG004D0003Q",
				"type"	:	"I",
				"name"	:	"ZD03 - Expression Job log",
				"icon"	:	"globe2",
				"url"	:	"#/prog01c1"
			}            
        ]
...
## SQL Files Detailed Analysis

### `backend/doc/qifu4.sql`

- Purpose: database schema and seed data script for core Qifu4 backend tables, system configuration, roles, menus, permissions, and related initialization data.
- CREATE TABLE count: 27
- INSERT target table count: 7
- Table summary:
  - `tb_account`: 1 columns; OID char(36
  - `tb_role`: 1 columns; OID char(36
  - `tb_role_permission`: 1 columns; OID char(36
  - `tb_sys`: 1 columns; OID char(36
  - `tb_sys_bean_help`: 1 columns; OID char(36
  - `tb_sys_bean_help_expr`: 1 columns; OID char(36
  - `tb_sys_bean_help_expr_map`: 1 columns; OID char(36
  - `tb_sys_code`: 1 columns; OID char(36
  - `tb_sys_event_log`: 1 columns; OID char(36
  - `tb_sys_expr_job`: 1 columns; OID char(36
  - `tb_sys_expr_job_log`: 1 columns; OID char(36
  - `tb_sys_expression`: 1 columns; OID char(36
  - `tb_sys_icon`: 1 columns; OID char(36
  - `tb_sys_jreport`: 1 columns; OID char(36
  - `tb_sys_jreport_param`: 1 columns; OID char(36
  - `tb_sys_login_log`: 1 columns; OID char(36
  - `tb_sys_mail_helper`: 1 columns; OID char(36
  - `tb_sys_menu`: 1 columns; OID char(36
  - `tb_sys_menu_role`: 1 columns; OID char(36
  - `tb_sys_prog`: 1 columns; OID char(36
  - `tb_sys_qfield_log`: 1 columns; OID char(36
  - `tb_sys_template`: 1 columns; OID char(36
  - `tb_sys_template_param`: 1 columns; OID char(36
  - `tb_sys_token`: 1 columns; OID char(36
  - `tb_sys_upload`: 1 columns; OID char(36
  - `tb_sys_usess`: 1 columns; OID char(36
  - `tb_user_role`: 1 columns; OID char(36
- INSERT summary:
  - `tb_account`: 1 statements
  - `tb_role`: 1 statements
  - `tb_sys`: 1 statements
  - `tb_sys_code`: 1 statements
  - `tb_sys_menu`: 1 statements
  - `tb_sys_prog`: 1 statements
  - `tb_user_role`: 1 statements
- Full path: `C:\home\qifu4\backend\doc\qifu4.sql`
- Size: 42728 bytes
