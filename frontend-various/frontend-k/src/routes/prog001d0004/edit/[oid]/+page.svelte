...
<div class="row">
    <div class="col-xs-6 col-md-6 col-lg-6">
        <FormGroup>
            ...
            <Input type="text" id="templateId" placeholder="輸入樣板編號" feedback={invalidFeedback('templateId', checkFields)} invalid={checkInvalid('templateId', checkFields)} bind:value={formParam.templateId} readonly={true} />
        </FormGroup>         
    </div>
    <div class="col-xs-6 col-md-6 col-lg-6">
        <FormGroup>
