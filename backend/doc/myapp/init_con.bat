...
docker cp C:\jenkins_home\workspace\qifu4test\doc\qifu4.sql myappcon:/root/qifu4.sql
docker cp C:\jenkins_home\workspace\qifu4test\app\target\core-app-0.0.4-SNAPSHOT.jar myappcon:/root/core-app-0.0.4-SNAPSHOT.jar
