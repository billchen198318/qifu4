...
<div class="row">
	<div class="col-xs-6 col-md-6 col-lg-6">
		...
		<input type="text" v-bind:class="'form-control ' + ( fieldCheckInvalid('reportId', checkFields) ? 'is-invalid' : ' ')" id="reportId" placeholder="輸入報表編號" v-model="this.formParam.reportId">
